    ...
    <div class="container">
      <br>
        ...
        <form action="{{route('clientes.busqueda')}}" method="GET" class="d-flex" role="search">
            <label for="busqueda" hidden>Formulario de busqueda</label><input id="busqueda" class="form-control me-2" type="search" name="valores" placeholder="Nombres, apellidos o cédula" aria-label="Buscar" required>
