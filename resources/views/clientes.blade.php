    ...
    <div class="container">
      <br>
        ...
        <form action="{{route('clientes.busqueda')}}" method="GET" class="d-flex" role="search">
            <label for="busqueda" hidden>Formulario de búsqueda</label><input id="busqueda" class="form-control me-2" type="search" name="valores" placeholder="Nombres, apellidos o cédula" aria-label="Buscar" required>
                          ...
                          buttons: [
                              {
                                  ...
                                  exportOptions: {
                                    columns: [ 0, 1, 2, 3] //Seleccionamos las columnas que se exportarán
                                  },
                              ...
                              },
                              {
                                  ...
                                  title: '<center>LISTADO DE CLIENTES</center>',
