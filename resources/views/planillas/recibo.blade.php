...
<main class="form-signin w-100 m-auto">
		...
		<!--BOTON DE REGRESAR-->
			<div title="Regresar" class="col-md-12 bg-light text-right"><a href="{{route('planillas.index')}}" type="submit" class="btn btn-primary float-start"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
        ...
        <script>
			...
			//EJECUCION MANUAL DE EXPORTACION	
		        	function generarPDF() {
			        	var element = document.getElementById('print-container');
						html2pdf(element, {
							ignore: ['#botones'],
