    ...
    <div class="container"> <!--INICIO DE CONTENEDOR-->  
      ...
      <!--INICIO DE MENSAJE DE RESULTADO DE CREACION DE PLANILLA-->
        ...
        <!--INICIO DE BOTON DE REGRESAR-->
	        <div class="col-md-12 mb-5 bg-light text-right"><a href="{{route('panel.index')}}" type="submit" class="btn btn-primary float-start"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
