...
<body>
	...
	<p>Por favor, acerquese a realizar el pago antes de la fecha máxima para evitar cortes del servicio</p>
	<p>Adicionalmente, puede revisar mas a detalle los valores de su planilla así como también los consumos asociados a la misma a través del siguiente enlace: </p>
	<p><a href="{{ route('consulta.index')}}">Consultar mis valores a pagar</a></p>
	<p><strong>Nota: </strong> Le notificamos que el mensaje recibido ha sido generado automáticamente por nuestro sistema, por favor no lo responda, en caso de tener dudas, comuniquese con el Municipio de Portovelo llamando al número <strong>(07)2949-197</strong>, o acerquese a nuestras oficinas.</p>
	<p>Saludos</p>
	<p>Atentamente,</p>
