          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="td_acciones">
                <!--BOTON EDITAR-->
                <div class="btn-group">
                    <a title="Editar medidor" type="button" href="editar.php" class="btn btn-outline-info"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
