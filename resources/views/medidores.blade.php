    ...
    <div class="container">
      <br>
        <!--BOTON DE HISTORIAL DE PAGOS-->
            <div class="col-md-12 text-right"><a title="Mantenimientos" href="{{route('mantenimientos.index')}}" type="submit" class="btn btn-dark float-start"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
