                ...
                <div class="btn-group">
                    ...
                    <!--BOTON ELIMINAR-->
                     <div class="btn-group"><form action="{{route('medidores.destroy', $medidoresItem )}}" method="POST">
                      @csrf @method('DELETE')
                      <button title="Eliminar medidor" class="btn btn-outline-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este medidor?')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
