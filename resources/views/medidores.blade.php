              ...
              <td class="td_acciones">
                ...
                <div class="btn-group">
                    <form action="" method="POST">
                      @csrf @method('UPDATE')
                    <button title="Editar medidor" type="button" href="editar.php" class="btn btn-outline-info"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                    ...
                    <!--BOTON ELIMINAR-->
                     <div class="btn-group"><form action="{{route('medidores.destroy', $medidoresItem )}}" method="POST">
                      @csrf @method('DELETE')
                      <button title="Eliminar medidor" class="btn btn-outline-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar el medidor {{$medidoresItem->numero_medidor}}?')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
