    ...
    <div class="container">
      ...
      <br><br>
        <form action="{{route('mantenimientos.busqueda')}}" method="GET" class="d-flex" role="search">
            <label for="busqueda" hidden>Formulario de busqueda:></label><input class="form-control me-2" type="search" id="busqueda" name="valores" placeholder="Número de solicitud o medidor" aria-label="Buscar" required>
