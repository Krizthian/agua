...
<style>
	...
	<center><h1><strong>CONSULTA DE VALORES A PAGAR</h1></strong></center>
		...
		<div class="container">
          ...
          <!--BOTON DE HISTORIAL-->
            <div class="col-md-12  text-left"><a href="#" title="Historial de pagos" type="submit" class="btn btn-dark float-right"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
