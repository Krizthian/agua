  ...
  <div class="container-fluid">
   ...
   <div class="text-end">
     ...
     <!--BOTON DE AJUSTES INICIO-->
          <a href="{{route('ajustes.index')}}" type="button" title="Ajustes" class="btn btn-success me-2"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-gear-wide-connected" viewBox="0 0 16 16">
