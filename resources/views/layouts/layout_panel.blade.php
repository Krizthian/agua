  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
        <!--    <li class="nav-item">
                <a class="nav-link " aria-current="page" href="#">Consulta</a>
              </li>
            <li class="nav-item">
                <a class="nav-link " aria-current="page" href="#">Medidores</a>
              </li>
              <li class="nav-item">
      ...
      <!--FIN DE TEXTO DE SALUDO-->
        <!--BOTON SALIR INICIO-->
          <div class="text-end">
          <a href="#" type="button" class="btn btn-outline-danger me-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
