...
<main class="form-signin w-100 m-auto">
  <form action="{{route('login.RecuperarProcesar')}}" method="POST" >
    ...
    <label for="email">Correo Electrónico</label>
      <input type="email" class="form-control" id="email" name="email" placeholder="Ingresa tu correo electrónico" required></input>
    <br>
    <button class="btn btn-success w-100 py-2" type="submit">Enviar</button>
    <br>
    <br>
    <center><a href="{{route('login')}}" class="mt-5 mb-3 text-body-secondary text-decoration-none">Iniciar Sesión</a></center>
